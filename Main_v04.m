...
headernumber=24;       % headers for columns of results (see end)
...
%     proc_var{record_no,46}=rhocxs;              % rhoc estimation for reservoir analysis
    ...
    proc_var{record_no,24}=version;         % version of main used
...
header = {'re_file' 'dippks1' 'dimpks' 'dippks2' 'dippksxs1' 'dimpksxs'...
    ...
    're_pb_pf', 're_ri', 're_wri','re_wrixs','corr_Pxs', 'corr_dI', 'version'}; % header
